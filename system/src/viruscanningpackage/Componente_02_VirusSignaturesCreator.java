...
public class Componente_02_VirusSignaturesCreator {
	...
	// Aqui voc� deve extrair da classe Componente_03_VirusScanningServer.java a
	// parte que se refere � cria��o de assinaturas.
	...
	private void initSignatureDB(String pathToSignatures) {
		...
		System.out.println("Started signature initialization on folder: " + VIRUS_DB_PATH);
