...
public class Componente_03_VirusScanningServer {
	...
	public int localScanFolder() {
		...
		System.out.println("Nr signatures: " + signatureDB.length + ". Nr files to scan: " + howManyFiles);
	 ...
	 * results which should be combined to get the total result. This will be done
	 * automatically by the main clone by calling this method.
	 * 
	 * @param params
